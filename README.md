...
- **Senhas**: guarda e-mail/login e senha de assinaturas e sites, organizadas em 3 blocos (Streaming, Trabalho/IA, Outros sites). A senha é criptografada no servidor (AES-256) antes de ser salva — o Supabase nunca vê o valor em texto puro. Cada senha fica mascarada por padrão, com botão pra revelar e botões de copiar (e-mail e senha) separados. Qualquer edição pede confirmação antes de salvar, pra evitar trocar a senha sem querer.
