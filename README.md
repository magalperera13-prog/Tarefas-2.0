...
- **Saldo Atual**: uma lista simples de "onde está seu dinheiro" — nome (conta, investimento, dinheiro em espécie etc.) e valor, com o total somado no topo. Sem histórico por mês; é uma fotografia do momento, editada no lugar sempre que o valor muda.
